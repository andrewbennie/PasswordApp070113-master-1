...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *saveLockerButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(saveLockerButton:)];
    ...
    UIBarButtonItem *cancelLockerButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancelLockerButton:)];
...
-(BOOL)textFieldShouldReturn:(UITextField *)lockerTextField
{
